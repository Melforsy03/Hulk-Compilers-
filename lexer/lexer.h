...
typedef enum {
    ...
    // Palabras clave
    TOKEN_LET, TOKEN_IN, TOKEN_FUNCTION, TOKEN_TYPE,TOKEN_RANGE,
    TOKEN_IF, TOKEN_ELIF, TOKEN_ELSE,TOKEN_THEN ,
    TOKEN_WHILE, TOKEN_FOR, TOKEN_TRUE, TOKEN_FALSE,
    TOKEN_NEW, TOKEN_INHERITS, TOKEN_SELF, TOKEN_BASE, TOKEN_RETURN,TOKEN_PRINT,
