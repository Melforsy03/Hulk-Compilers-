...
Symbol* t_mult = add_symbol(g, "START", TERMINAL);
...
Symbol* right_less[] = {nt_term, t_less, nt_comparison};
Symbol* right_greater[] = {nt_term, t_greater, nt_comparison};
Symbol* right_less_eq[] = {nt_term, t_less_eq, nt_comparison};
Symbol* right_greater_eq[] = {nt_term, t_greater_eq, nt_comparison};
Symbol* right_comp_base[] = {nt_term};
